...
describe('POST /api/articles/:article_id/comments', () => {
  ...
  test('400: Responds with an error message 400: Bad Request for request body that is missing username', () => {
    return request(app)
      .post('/api/articles/4/comments')
      .send({
        body: "I am commenting on this post from an airplane, does that make me a bird? Careful, Sam. Too much pondering and you'll wake up a cat, vaguely disappointed.",
  ...
  test('400: Responds with an error message 400: Bad Request for request body that is missing body', () => {
    return request(app)
      .post('/api/articles/4/comments')
      .send({
        username: 'butter_bridge',
  ...
  test('400: Responds with an error message 400: Bad Request for request body with invalid username', () => {
    return request(app)
      .post('/api/articles/4/comments')
      .send({
        username: 99,
  ...
  test('400: Responds with an error message 400: Bad Request for request body with invalid body', () => {
    return request(app)
      .post('/api/articles/4/comments')
      .send({
        username: 'butter_bridge',
...
describe('PATCH /api/articles/:article_id', () => {
  ...
  test('400: Responds with an error message 400: Bad Request for request body that is missing the required fields', () => {
    return request(app)
      ...
      .expect(400)
      .then(({ body }) => {
        expect(body.msg).toBe('Invalid or Missing Votes');
      });
  });
  test('400: Responds with an error message 400: Bad Request for invalid data types in the request body', () => {
    return request(app)
...
describe('POST /api/articles', () => {
  ...
  //sad path
  test('400: Responds with an error message 400: Bad Request for a request body that is missing more than one required field', () => {
    return request(app)
      .post('/api/articles')
      .send({})
      .expect(400)
  ...
  test('400: Responds with an error message 400: Bad Request for a request body that is missing author', () => {
    return request(app)
      .post('/api/articles')
      .send({
        title: 'Cookies, so many types',
      ...
      .expect(400)
      .then(({ body }) => {
        expect(body.msg).toBe('Author is required');
      });
  });
  test('400: Responds with an error message 400: Bad Request for a request body that is missing title', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 'butter_bridge',
      ...
      .expect(400)
      .then(({ body }) => {
        expect(body.msg).toBe('Title is required');
      });
  });
  test('400: Responds with an error message 400: Bad Request for a request body that is missing body', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 'butter_bridge',
  ...
  test('400: Responds with an error message 400: Bad Request for a request body that is missing topic', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 'butter_bridge',
  ...
  test('400: Responds with an error message 400: Bad Request for request body that has more than one invalid data type', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 600,
  ...
  test('400: Responds with an error message 400: Bad Request for request body that has invalid author', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 600,
  ...
  test('400: Responds with an error message 400: Bad Request for request body that has invalid title', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 'butter_bridge',
  ...
  test('400: Responds with an error message 400: Bad Request for request body that has invalid body', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 'butter_bridge',
  ...
  test('400: Responds with an error message 400: Bad Request for request body that has invalid topic', () => {
    return request(app)
      .post('/api/articles')
      .send({
        author: 'butter_bridge',
